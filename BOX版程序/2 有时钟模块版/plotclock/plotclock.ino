...
//【此数值可能需要调节】
#define SERVOLEFTNULL 1930  //数值减小，顺时针旋转，加大则逆时针旋转 默认2000
//【此数值可能需要调节】
#define SERVORIGHTNULL 960  //数值减小，顺时针旋转，加大则逆时针旋转  默认1000

//2.调节到位0、180，再调节下面参数
//左右悬臂舵机的90度位置,，数字增加，左侧舵机顺时针调整，右侧舵机逆时针调整
//【此数值可能需要调节】
#define SERVOFAKTORLEFT 690 //数值加大，顺时针旋转，减小则逆时针旋转 默认650
//【此数值可能需要调节】
...
//升举舵机的3个角度 
//【此数值可能需要调节】
#define LIFT0 1830 //落笔写字 
#define LIFT1 1730  //写字时抬臂动作 一般比lift0 小100左右
#define LIFT2 1600  //高抬笔架  
//【此数值可能需要调节】
